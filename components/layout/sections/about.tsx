...
export function AboutSection() {
  return (
    <section id="about" className="relative py-24 sm:py-32 overflow-hidden bg-gray-50 dark:bg-gray-900/50">
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-100 dark:border-gray-700 hover:shadow-md hover:border-[#29ABE2]/20 transition-all duration-300">
                <div className="flex items-center mb-2">
                  <div className="bg-[#29ABE2]/10 p-2 rounded-lg mr-3">
                    <Building2 className="text-[#29ABE2] h-5 w-5" />
                  </div>
                  <h4 className="font-bold">Nossa Fábrica</h4>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-100 dark:border-gray-700 hover:shadow-md hover:border-[#29ABE2]/20 transition-all duration-300">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-bold">Qualidade</h4>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400">
